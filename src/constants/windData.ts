export const WIND_DATA: Record<string, { summer: number; winter: number; lat: number; lng: number }> = {
  ...
  tsu:       { summer: 180, winter: 315, lat: 34.73, lng: 136.51 },
  ueno:      { summer: 195, winter: 315, lat: 34.77, lng: 136.13 },
  owase:     { summer: 180, winter: 315, lat: 34.07, lng: 136.19 },
  osaka:     { summer: 210, winter: 300, lat: 34.69, lng: 135.50 },
  nara:      { summer: 195, winter: 315, lat: 34.69, lng: 135.83 },
